...
class FFAppState extends ChangeNotifier {
  ...
  int _lastProcessedMessageCount = 0;
  int get lastProcessedMessageCount => _lastProcessedMessageCount;
  set lastProcessedMessageCount(int value) {
    _lastProcessedMessageCount = value;
    debugLogAppState(this);
  }
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'showContainer': debugSerializeParam(
          showContainer,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=appValues&appValuesTab=state',
          searchReference:
              'reference=CiEKGQoNc2hvd0NvbnRhaW5lchIIbjdoOTJkMnNyAggFegBaDXNob3dDb250YWluZXI=',
          name: 'bool',
          nullable: false,
        )
      };
